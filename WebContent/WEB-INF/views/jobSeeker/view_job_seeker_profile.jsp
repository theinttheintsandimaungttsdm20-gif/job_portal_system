        ...
        <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(resources/images/banner/bnr1.jpg);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">Job Seeker Profile</h1>
					<!-- Breadcrumb row -->
					<div class="breadcrumb-row">
						<ul class="list-inline">
							<li><a href="#">Home</a></li>
							<li>View Job Seeker Detail Information</li>
						</ul>
					</div>
					<!-- Breadcrumb row END -->
                </div>
								...
								<div class="row">
									...
									<div class="col-lg-12 col-md-6">
										<div class="widget bg-white p-lr20 p-t20  widget_getintuch radius-sm">
											<h4 class="text-black font-weight-700 p-t10 m-b15">Job Seeker Address Info</h4>
											<ul>
												<li><i class="ti-location-pin"></i><strong class="font-weight-700 text-black">Address</strong><span class="text-black-light">${jobSeekerModel.jobSeeker.address}</span></li>
												<li><i class="ti-money"></i><strong class="font-weight-700 text-black">State</strong>${jobSeekerModel.jobSeeker.state}</li>
												<li><i class="ti-shield"></i><strong class="font-weight-700 text-black">Postal Code</strong>${jobSeekerModel.jobSeeker.postalCode}</li>
											</ul>
										</div>
									</div>
								</div>
						...
						<div class="col-lg-8">
							<div class="job-info-box">
								<h3 class="m-t0 m-b10 font-weight-700 title-head">
									<a href="#" class="text-secondry m-r30">${jobSeekerModel.jobSeeker.name}</a>
								</h3>
								<ul class="job-info">
									<li><strong>Job Seeker Id: </strong>${jobSeekerModel.jobSeeker.jobSeekerId}</li>
									<li><strong>Email: </strong>${jobSeekerModel.jobSeeker.email}</li>
									<li><strong>Phone: </strong>${jobSeekerModel.jobSeeker.phone}</li>
								</ul>
								<br>
								<h5 class="font-weight-600">Job Seeker Info Detail</h5>
								<div class="dez-divider divider-2px bg-gray-dark mb-4 mt-0"></div>
								<ul class="list-num-count no-round">
									<li>Birth Date is ${jobSeekerModel.jobSeeker.dob }</li>
									<li>${jobSeekerModel.jobSeeker.gender }</li>
									<li>Especially has the skills of ${jobSeekerModel.jobSeeker.skills }</li>
									<li><a href="getEduPath?frmId=${jobSeekerModel.jobSeeker.jobSeekerId}&frmRole=recruiter">Education Detail</a></li>
									<li><a href="getExpPath?frmId=${jobSeekerModel.jobSeeker.jobSeekerId}&frmRole=recruiter">Work Experience Detail</a></li>
								</ul>
