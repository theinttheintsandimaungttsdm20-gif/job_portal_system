        ...
        <div class="dez-bnr-inr overlay-black-dark" style="background-image:url(resources/images/banner/bnr1.jpg);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">Update Education</h1>
					<!-- Breadcrumb row -->
					<div class="breadcrumb-row">
						<ul class="list-inline">
							<li><a href="#">Home</a></li>
							<li>Update Education</li>
						</ul>
					</div>
					<!-- Breadcrumb row END -->
                </div>
			...
			<input type="hidden" 
				value="${frmEduId}" name="frmEduId" />
						<div class="form-group">
							...
							<sform:input path="institutionAttended" class="form-control" value="${fileBucket.jobSeekerEdu.institutionAttended}"/>
						</div>
						<div class="form-group">
							<label>Completion Month</label>
							<sform:input type="month" path="completionDate" class="form-control" value="${fileBucket.jobSeekerEdu.completionDate}"/>
						</div>
						<div class="form-group">
							<label>Certification</label>
							<sform:input path="certification" class="form-control" value="${fileBucket.jobSeekerEdu.certification}"/>
							</div>
				
						<div class="form-group">
							<label>Certification File(Optional)</label>
							<div class="custom-file">
								<sform:input type="file" path="file" class="site-button" value="${fileBucket.jobSeekerEdu.certificationFile}" id="customFile"/> 
							</div>
