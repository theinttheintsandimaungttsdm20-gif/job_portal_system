...
<body id="bg">
        ...
        <div class="dez-bnr-inr overlay-black-dark" style="background-image:url(resources/images/banner/bnr1.jpg);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">Register Work Experience</h1>
					<!-- Breadcrumb row -->
					<div class="breadcrumb-row">
						<ul class="list-inline">
							<li><a href="#">Home</a></li>
							<li>Register Work Experience</li>
						</ul>
					</div>
					<!-- Breadcrumb row END -->
                </div>
  ...
  <input type="hidden" value="${sessionScope.frmSeekerId}" name="frmSeekerId"/>

						<div class="form-group">
							<label>Company</label>
							<sform:input path="frmCompanyName" class="form-control" placeholder="Enter Company Name"/>
						</div>
						<div class="form-group">
							<label>Role</label>
							<sform:input path="frmRole" class="form-control" placeholder="Enter Your Job Role"/>
						</div>
						<div class="form-group">
							<label>Start Date</label>
							<sform:input type="date" path="frmStartDate" class="form-control"/>
						</div>
						<div class="form-group">
							<label>End Date</label>
							<sform:input type="date" path="frmEndDate" class="form-control"/>
						</div>
