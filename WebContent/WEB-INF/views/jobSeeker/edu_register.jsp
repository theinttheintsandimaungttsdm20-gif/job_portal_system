        ...
        <div class="dez-bnr-inr overlay-black-dark" style="background-image:url(resources/images/banner/bnr1.jpg);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">Register Education</h1>
					<!-- Breadcrumb row -->
					<div class="breadcrumb-row">
						<ul class="list-inline">
							<li><a href="#">Home</a></li>
							<li>Register Education</li>
						</ul>
					</div>
					<!-- Breadcrumb row END -->
                </div>
...
action="saveEduPath">
	       <input type="hidden" path="jobSeekerId" value="${sessionScope.frmSeekerId}" name="frmSeekerId"/>
						...
						<div class="form-group">
							...
							<sform:input path="institutionAttended" class="form-control" placeholder="Enter Institution Attended"/>
						</div>
						<div class="form-group">
							<label>Completion Month</label>
							<sform:input type="month" path="completionDate" class="form-control"/>
						</div>
						<div class="form-group">
							<label>Certification</label>
							<sform:input path="certification" class="form-control" placeholder="Enter Certification Name"/>
							</div>
				
						<div class="form-group">
							<label>Certification File(Optional)</label>
							<div class="custom-file">
								<sform:input type="file" path="file" class="site-button" id="customFile"/> 
							</div>
