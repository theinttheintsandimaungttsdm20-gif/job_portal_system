        ...
        <div class="dez-bnr-inr overlay-black-dark" style="background-image:url(resources/images/banner/bnr1.jpg);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">Update Work Experience</h1>
					<!-- Breadcrumb row -->
        ...
        <div class="content-block">
			...
			<sform:form method="POST" modelAttribute="expModel" action="updateExpPath">
						...
						<div class="form-group">
							<label>Company</label>
							<sform:input path="frmCompanyName" class="form-control" value="${expModel.frmExp.companyName}"/>
						</div>
						<div class="form-group">
							<label>Role</label>
							<sform:input path="frmRole" class="form-control" value="${expModel.frmExp.role}"/>
						</div>
						<div class="form-group">
							<label>Start Date</label>
							<sform:input type="date" path="frmStartDate" class="form-control" value="${expModel.frmExp.startDate}"/>
						</div>
						<div class="form-group">
							<label>End Date</label>
							<sform:input type="date" path="frmEndDate" class="form-control" value="${expModel.frmExp.endDate}"/>
						</div>
