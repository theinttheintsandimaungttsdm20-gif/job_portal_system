...
<body id="bg">
    ...
    <div class="page-content bg-white">
        ...
        <div class="dez-bnr-inr overlay-black-dark" style="background-image:url(resources/images/banner/bnr1.jpg);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">Register Application</h1>
					<!-- Breadcrumb row -->
        ...
        <div class="content-block">
			...
			action="saveAppPath">
				       <input type="hidden" value="${frmSeekerId}" name="frmSeekerId"/>
				       <input type="hidden" value="${frmRecruiterId}" name="frmRecruiterId"/>
				       <input type="hidden" value="${frmJobId}" name="frmJobId"/>

						<div class="form-group">
							<label>Check Status</label>
							<label class="form-control">pending</label>
						</div>
					
						<div class="form-group">
							<label>Detail Info</label>
						<sform:textarea class="form-control" path="resume" placeholder="Enter Your Detail Info for Resume"/>						
						</div>
				
						<div class="form-group">
							<label>Resume File*</label>
							<div class="custom-file">
								<sform:input type="file" requiered="" path="file" class="site-button" id="customFile"/> 
							</div>
