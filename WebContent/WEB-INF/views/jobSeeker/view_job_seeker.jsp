				...
				<div class="main-bar clearfix">
					<div class="container clearfix">
						...
						<div class="logo-header mostion">
							<a href="#"><img src="resources/images/logo.png" class="logo" alt=""></a>
						</div>
						<!-- nav toggle button -->
						<!-- nav toggle button -->
		...
		<div class="page-content bg-white">
			...
			<div class="content-block">
				...
				<div class="section-full bg-white submit-resume content-inner-2">
					<div class="container">
						<sform:form modelAttribute="jobSeekerModel"
							action="updateJobSeekerPath" method="post">
							<input type="hidden" value="${userLogin.loginId}"
								name="frmJobSeekerId" />
							<div class="form-group">
								<label>ID</label> <label class="form-control">${jobSeekerModel.jobSeeker.jobSeekerId}</label>
							</div>

							<div class="form-group">
								<label>Name</label>
								<sform:input path="frmName"
									value="${jobSeekerModel.jobSeeker.name}" class="form-control" />
							</div>
							<div class="form-group">
								<label>Email</label>
								<sform:input path="frmEmail" class="form-control"
									value="${jobSeekerModel.jobSeeker.email}" />
							</div>
							<div class="form-group">
								<label>Phone</label>
								<sform:input path="frmPhone"
									value="${jobSeekerModel.jobSeeker.phone}" class="form-control"/>
							</div>
							<div class="form-group">
								<label>Skills</label>
								<sform:input path="frmSkills"
									value="${jobSeekerModel.jobSeeker.skills}" class="form-control" />
							</div>
							<div class="form-group">
								<label>Gender</label>
								<sform:input path="frmGender"
									value="${jobSeekerModel.jobSeeker.gender}" class="form-control" />
							</div>
							<div class="form-group">
								<label>Date of Birth</label>
								<sform:input path="frmDob"
									value="${jobSeekerModel.jobSeeker.dob}" type="date"
									class="form-control" />
							</div>
							<div class="form-group">
								<label>Address</label>
								<sform:input path="frmAddress"
									value="${jobSeekerModel.jobSeeker.address}"
									class="form-control" />
							</div>
							<div class="form-group">
								<label>State</label><br> <label>${jobSeekerModel.jobSeeker.state}</label>
							</div>
							<div class="form-group">
								<label>Select State</label>
								<sform:select mult="single" path="frmState" name="frmState"
									id="frmState" class="form-control">
							...
							<div class="form-group">
								...
								<sform:input path="frmPostalCode"
									value="${jobSeekerModel.jobSeeker.postalCode}"
									class="form-control" />
							</div>
							<button type="submit" class="site-button">Update</button>
							<br><br>
							<div class="form-group">
								<label>Favorite Job Category</label>&nbsp;&nbsp;&nbsp;
								<c:if test="${(registerJobSeekerForm.mapFavCategory!='null')}">
									<c:forEach var="at"
										items="${registerJobSeekerForm.mapFavCategory}" varStatus="s">&nbsp;
										<label>${at.value}</label>
										<label><a
											href="deleteFavCategoryPath?frmCatId=${at.key}&frmJobSeekerId=${userLogin.loginId}"><i
						...
						<sform:form modelAttribute="registerJobSeekerForm" action="updateFavCategoryPath" method="post">
							<input type="hidden" value="${userLogin.loginId}" name="frmJobSeekerId" />
							<div class="form-group">
									<label>Check Update FavCategory:</label>
						...
						<sform:form modelAttribute="loginModel"
							...
							<div class="form-group">
								...
								<div class="form-group">
									...
									<sform:input path="frmPassword" type="password"
										class="form-control" placeholder="Enter Current Password" />
								</div>
								<div class="form-group">
									<label>New Password</label>
									<sform:input path="frmNewPassword" type="password"
										class="form-control" placeholder="Enter New Password" />
								</div>
								<input type="hidden" path="frmLoginId"
				value="${userLogin.loginId}" name="frmLoginId" />
								<div class="form-group">
									<label>Retype Password</label>
									<sform:input path="frmRePassword" type="password"
										class="form-control" placeholder="Enter Retype Password" />
								</div>
							...
							<div class="col-xl-5 col-lg-4 col-md-12 col-sm-12">
								<div class="widget">
									...
									<p class="text-capitalize m-b20">Lorem Ipsum is simply
										dummy text of the printing and typesetting industry has been
