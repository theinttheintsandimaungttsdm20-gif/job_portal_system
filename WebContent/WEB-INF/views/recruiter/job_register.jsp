...
<sform:form modelAttribute="registerJobForm" action="saveJobPath" method="post">
  			<input type="hidden" value="${userLogin.loginId}" name="frmRecruiterId"/>
						<div class="form-group">
							...
							<sform:input path="jobModel.frmJobTitle" class="form-control" placeholder="Enter Job Title Name"/>
						</div>
						<div class="form-group">
							<label>Select Category</label>
							<sform:select path="jobModel.frmCatId" name="" id="" class="form-control"> 
					...
					<sform:radiobutton path="jobModel.frmGender" value="both" label="both"/>							
						...
						<div class="form-group">
							...
							<sform:input path="jobModel.frmAge" class="form-control" placeholder="Enter Age"/> 
							
						</div>
						<div class="form-group">
							<label>Job Role</label>
							
							<sform:input path="jobModel.frmJobRole" class="form-control" placeholder="Enter Job Role"/> 
							
						</div>
						<div class="form-group">
							<label>Skills Required</label>
							
								<sform:input path="jobModel.frmSkillsRequired" class="form-control" placeholder="Enter Skills Required"/> 
							
						</div>							
						<div class="form-group">
							<label>Job Qualification</label>
							
								<sform:input path="jobModel.frmJobQualification" class="form-control" placeholder="Enter Job Qualification"/> 
							
						</div>
						<div class="form-group">
							<label>Experience Year</label>
								<sform:input type="number" min="1" max="10" path="jobModel.frmJobExperience" class="form-control" placeholder="Enter Job Experience Year"/> 
							
						</div>
						<div class="form-group">
							<label>Job Post</label>
							
								<sform:input path="jobModel.frmJobPost" class="form-control" placeholder="Enter Job Post"/> 
							
						</div>
						<div class="form-group">
							<label>Expected Salary</label>
								<sform:input path="jobModel.frmExpectedSalary" class="form-control" placeholder="Enter Expected Salary"/> 
						</div>
						<div class="form-group">
							<label>Job Location</label>
								<sform:input path="jobModel.frmJobLocation" class="form-control" placeholder="Enter Job Location"/> 
						</div>
						<div class="form-group">
							<label>Job Open Date</label>
								<sform:input type="datetime-local" path="jobModel.frmJobOpenDate" class="form-control"/> 
						</div>
						<div class="form-group">
							<label>Job Close Date</label>
								<sform:input type="date" path="jobModel.frmJobCloseDate" class="form-control"/> 
						</div>			
						<div class="form-group">
							<label>Job Description</label>
							
								<sform:textarea path="jobModel.frmDescription" class="form-control"/> 
						</div>																																												
