			...
			<div class="sticky-header main-bar-wraper navbar-expand-lg">
				<div class="main-bar clearfix">
					...
					<div class="page-content">
						<!-- Section Banner -->
						<div class="dez-bnr-inr dez-bnr-inr-md" style="background-image:url(resources/images/main-slider/slide2.jpg);">
							<div class="container">
						...
						<!-- Section Banner END -->
						<!-- About Us -->
						<div class="section-full job-categories content-inner-2 bg-white" style="background-image:url(resources/images/pattern/pic1.html);">
							<div class="container">
						...
						<div class="section-full content-inner bg-gray">
								...
								<div class="row">
									...
									<div class="row">
										<div class="col-lg-3 col-sm-6 col-md-6 m-b30">
											<div class="city-bx align-items-end  d-flex" style="background-image:url(resources/images/city/Yangon.jpg)">
												<div class="city-info">
													<h5>Yangon</h5>
													<span>765 Jobs</span>
												</div>
										...
										<div class="col-lg-3 col-sm-6 col-md-6 m-b30">
											<div class="city-bx align-items-end  d-flex" style="background-image:url(resources/images/city/Mandalay.jpg)">
												<div class="city-info">
													<h5>Mandalay</h5>
													<span>352 Jobs</span>
												</div>
										...
										<div class="col-lg-3 col-sm-6 col-md-6 m-b30">
											<div class="city-bx align-items-end  d-flex" style="background-image:url(resources/images/city/NayPyiTaw.jpg)">
												<div class="city-info">
													<h5>Nay Pyi Taw</h5>
													<span>893 Jobs</span>
												</div>
										...
										<div class="col-lg-3 col-sm-6 col-md-6 m-b30">
											<div class="city-bx align-items-end  d-flex" style="background-image:url(resources/images/city/pic4.jpg)">
												<div class="city-info">
													<h5>Gambia</h5>
													<span>502 Jobs</span>
												</div>
										...
										<div class="col-lg-3 col-sm-6 col-md-6 m-b30">
											<div class="city-bx align-items-end  d-flex" style="background-image:url(resources/images/city/pic5.jpg)">
												<div class="city-info">
													<h5>India</h5>
													<span>765 Jobs</span>
												</div>
										...
										<div class="col-lg-3 col-sm-6 col-md-6 m-b30">
											<div class="city-bx align-items-end  d-flex" style="background-image:url(resources/images/city/pic6.jpg)">
												<div class="city-info">
													<h5>Thailand</h5>
													<span>352 Jobs</span>
												</div>
										...
										<div class="col-lg-3 col-sm-6 col-md-6 m-b30">
											<div class="city-bx align-items-end  d-flex" style="background-image:url(resources/images/city/pic7.jpg)">
												<div class="city-info">
													<h5>Banjul</h5>
													<span>893 Jobs</span>
												</div>
										...
										<div class="col-lg-3 col-sm-6 col-md-6 m-b30">
											<div class="city-bx align-items-end  d-flex" style="background-image:url(resources/images/city/pic8.jpg)">
												<div class="city-info">
													<h5>Spain</h5>
													<span>502 Jobs</span>
												</div>
							...
							<!-- Our Job -->
								...
								<!-- Call To Action -->
								<div class="section-full p-tb70 overlay-black-dark text-white text-center bg-img-fix" style="background-image: url(resources/images/background/bg4.jpg);">
									<div class="container">
										...
										<div class="blog-carousel-center owl-carousel owl-none">
												...
												<div class="testimonial-5">
													...
													<div class="testimonial-detail clearfix">
														<div class="testimonial-pic radius shadow">
															<img src="resources/images/testimonials/pic1.jpg" width="100" height="100" alt="">
														</div>
											...
											<div class="item">
												<div class="testimonial-5">
													...
													<div class="testimonial-detail clearfix">
														<div class="testimonial-pic radius shadow">
															<img src="resources/images/testimonials/pic2.jpg" width="100" height="100" alt="">
														</div>
														<strong class="testimonial-name">David Matin</strong> 
														<span class="testimonial-position">Student</span> 
													</div>
											...
											<div class="item">
												<div class="testimonial-5">
													...
													<div class="testimonial-detail clearfix">
														<div class="testimonial-pic radius shadow">
															<img src="resources/images/testimonials/pic3.jpg" width="100" height="100" alt="">
														</div>
														<strong class="testimonial-name">David Matin</strong> 
														<span class="testimonial-position">Student</span> 
													</div>
									...
									<div class="container">
										<div class="row">
											<div class="col-xl-5 col-lg-4 col-md-12 col-sm-12">
												<div class="widget">
													<img src="resources/images/logo-white.png" width="180" class="m-b15" alt=""/>
