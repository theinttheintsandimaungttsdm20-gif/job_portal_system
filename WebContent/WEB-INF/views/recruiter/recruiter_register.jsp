					...
					<div class="col-md-12 m-b30">
						<div class="p-a30 border-1  max-w500 m-auto">
							<div class="tab-content">
								<sform:form id="login" class="tab-pane active"
									modelAttribute="registerRecruiterForm"
									action="saveRecruiterPath" method="post">
									<h4 class="font-weight-700">Register Recruiter</h4>
									<p class="font-weight-600">If you have an account with us,
										please log in.</p>
									<div class="form-group">

										<label class="font-weight-700"> ID </label>
										<sform:input name="dzName" required="" class="form-control"
											placeholder="ID" path="recruiterModel.frmRecruiterId"
									...
									<div class="form-group">
										...
										<sform:input name="dzName" required="" class="form-control"
											...
											path="recruiterModel.frmRecruiterName" />
									...
									<div class="form-group">
										...
										<sform:input name="dzName" required="" class="form-control"
											...
											path="recruiterModel.frmCompanyName" />

									</div>
									<div class="form-group">

										<label class="font-weight-700"> Company License *</label>
										<sform:input name="dzName" required="" class="form-control"
											placeholder="Enter Company License"
											path="recruiterModel.frmCompanyLicense" />
									...
									<div class="form-group">
										...
										<sform:input name="dzName" required="" class="form-control"
											placeholder="Enter Email" path="recruiterModel.frmEmail" />
									...
									<div class="form-group">
										...
										<sform:input name="dzName" required="" class="form-control"
											placeholder="Enter Company Address" path="recruiterModel.frmAddress" />
									...
									<div class="form-group">
										...
										<sform:input name="dzName" required="" class="form-control"
											placeholder="Type Password" path="loginModel.frmPassword"
											type="password" />
									...
									<div class="form-group">
										...
										<sform:radiobutton required="" path="recruiterModel.frmState"
										...
										<sform:input name="dzName" required="" class="form-control"
											...
											path="recruiterModel.frmPostalCode" />
									...
									<div class="form-group">
										...
										<sform:input name="dzName" required="" class="form-control"
											...
											path="recruiterModel.frmDescription" type="textarea"/>

									</div>
									<div class="text-left">
										<button name="save"
											class="site-button button-lg outline outline-2">CREATE</button>
									</div>
								</sform:form>
							</div>
						</div>
					...
					<div class="col-xl-5 col-lg-5 col-md-8 col-sm-8 col-12">
                        <div class="widget border-0">
                            ...
                            <ul class="list-2 list-line">
                                ...
                                <li><a href="#">Lending License</a></li>
