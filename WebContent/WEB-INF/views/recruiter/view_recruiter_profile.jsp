        ...
        <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(resources/images/banner/bnr1.jpg);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">Recruiter Profile</h1>
					<!-- Breadcrumb row -->
					<div class="breadcrumb-row">
						<ul class="list-inline">
							<li><a href="#">Home</a></li>
							<li>View Recruiter Profile</li>
						</ul>
					</div>
					<!-- Breadcrumb row END -->
                </div>
								...
								<div class="row">
									...
									<div class="col-lg-12 col-md-6">
										<div class="widget bg-white p-lr20 p-t20  widget_getintuch radius-sm">
											<h4 class="text-black font-weight-700 p-t10 m-b15">Address Info</h4>
											<ul>
												<li><i class="ti-location-pin"></i><strong class="font-weight-700 text-black">Address</strong><span class="text-black-light">${recruiterModel.recruiter.address}</span></li>
												<li><i class="ti-money"></i><strong class="font-weight-700 text-black">State</strong>${recruiterModel.recruiter.state}</li>
												<li><i class="ti-shield"></i><strong class="font-weight-700 text-black">Postal Code</strong>${recruiterModel.recruiter.postalCode}</li>
											</ul>
										</div>
									</div>
								</div>
						...
						<div class="col-lg-8">
							<div class="job-info-box">
								<h3 class="m-t0 m-b10 font-weight-700 title-head">
									<a href="#" class="text-secondry m-r30">${recruiterModel.recruiter.recruiterName}</a>
								</h3>
								<ul class="job-info">
									<li><strong>Id: </strong>${recruiterModel.recruiter.recruiterId}</li>	<br>							
									<li><strong>Company Name: </strong>${recruiterModel.recruiter.companyName}</li><br>
									<li><strong>Company License: </strong>${recruiterModel.recruiter.companyLicense}</li><br>
									<li><strong>Email: </strong>${recruiterModel.recruiter.email}</li>
								...
								<p>${recruiterModel.recruiter.description}</p>
